...
import 'package:artifitia_test/features/auth/presentation/screen/login_screen.dart';
...
import '../../../onboard/presentation/screen/get_started_screen.dart';
import '../controller/bloc/auth_bloc.dart';
import '../widgets/auth_textfield_widget.dart';
import '../widgets/social_media_login_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  AuthTexFormFeildWidget(
                    ...
                    suffixIcon: SizedBox(),
                    validator: (p0) {
                      if (p0 == null || _emailController.text.isEmpty) {
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => AuthTexFormFeildWidget(
                        ...
                        hintext: 'Password',
                        obsecureText: authController.signUpPassIsObsecure.value,
                        prefixIcon: Icons.lock,
                        suffixIcon: IconButton(
                            onPressed: () {
                              authController.signUpPassIsObsecure.value =
                                  !authController.signUpPassIsObsecure.value;
                            },
                            icon: Icon(authController.signUpPassIsObsecure.value
                  ...
                  Obx(
                    () => AuthTexFormFeildWidget(
                      ...
                      obsecureText:
                          authController.signUpConfirmPassIsObsecure.value,
                      prefixIcon: Icons.lock,
                      suffixIcon: IconButton(
                          onPressed: () {
                            authController.signUpConfirmPassIsObsecure.value =
                                !authController
                                    .signUpConfirmPassIsObsecure.value;
                          },
                          icon: Icon(
                              authController.signUpConfirmPassIsObsecure.value
                                  ? Icons.visibility_off
                      ...
                      validator: (p0) {
                        if (p0 == null ||
                          ...
                          return 'passowrd and confirm password is incorrect';
                        } else {
                          return null;
                        }
                      },
